...
!function (NioApp, $) {
  ...
  NioApp.CurrentLink = function () {
    ...
    $(_link).each(function () {
      var self = $(this),
        ...
        _self_link=_self_link.replace('?', '-');
        fileName=fileName.replace('?', '-');

        //console.log(fileName.toLocaleLowerCase());
        //console.log(_self_link.toLocaleLowerCase());

        //console.log(fileName.toLocaleLowerCase().match(_self_link.toLocaleLowerCase()));

      if (fileName.toLocaleLowerCase().match(_self_link.toLocaleLowerCase())) {
  ...
  NioApp.DataTable.init = function () {
    NioApp.DataTable('.datatable-init', {
      ...
      $.fn.DataTable.ext.pager.numbers_length = 50;


      AddTHEAD('ctl00_ContentPlaceHolder1_grdData');
      $('#ctl00_ContentPlaceHolder1_grdData').dataTable({
          pageLength: 50,
          responsive: true,
          autoWidth: false,
          deferLoading:50,
