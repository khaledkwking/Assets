<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/_shared/Main.Master" AutoEventWireup="true" CodeBehind="InboundItemReceving.aspx.cs" Inherits="UI.Web.Modules.StoreOperations.Forms.Inboud.InboundItemReceving" %>
            ...
            <div class="card-inner-group">
                ...
                <div class="card-inner p-0" id="divShow" runat="server">
                    ...
                    <asp:DataGrid ID="grdInboundItems" runat="server"
                        DataKeyField="InboubdItemId" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" class="table table-hover table-striped table-bordered table-advanced tablesorter"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="<%$ Resources:pages,ReceviedQty %> ">
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="txtQty" Text='<%#Eval("ReceivedQty") %>' runat="server" class="form-control" Width="100px"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
