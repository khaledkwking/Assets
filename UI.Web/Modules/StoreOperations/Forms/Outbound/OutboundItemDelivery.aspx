<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/_shared/Main.Master" AutoEventWireup="true" CodeBehind="OutboundItemDelivery.aspx.cs" Inherits="UI.Web.Modules.StoreOperations.Forms.Outboud.OutboundItemDelivery" %>
                                ...
                                <li>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu  dropdown-menu-right" style="">
                                            <ul class="link-check">
                                                <li>
                                                    <asp:LinkButton runat="server" ID="btnSave" Visible="false" class=" " OnClick="btnSave_Click1"><i class="icon ni ni-save"></i>&nbsp; <%=GetGlobalResourceObject("pages","DeliverSelectedItems") %>&nbsp;</asp:LinkButton></li>
                                            </ul>
                ...
                <div class="card-inner p-0" id="divShow" runat="server">
                    ...
                    <asp:DataGrid ID="grdOutboundItems" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="<%$ Resources:pages,DeliveredQry %> ">
