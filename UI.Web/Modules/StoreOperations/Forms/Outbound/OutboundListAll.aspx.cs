...
{
    public partial class OutboundListAll : BaseFormAdmin
    {
        ...
        public string showRequestType(int TypeCode, string TypeText)
        {
            ...
            switch (TypeCode)
            {
                case 1:
                    {
                        _out = "<span class='badge badge-dim badge-success'><em class='icon ni ni-user-fill'></em><span>" + TypeText + "</span></span>";
                        break;
                    }
                case 2:
                    {
                        _out = "<span class='badge badge-dim badge-light text-warning'><em class='icon ni ni-building'></em><span>" + TypeText + "</span></span>";
                        break;
                    }
                case 3:
                    {
                        _out = "<span class='badge badge-dim badge-light text-secondary'><em class='icon ni ni-tranx-fill'></em><span>" + TypeText + "</span></span>";
                        break;
                    }
                default:
                    _out = "";
        ...
        {
            FillDllwithoptional_ALL(LooksUpsRepository.ins.FillOutboundTypes(), lstFilterOutType, "TitleAr", "Code", Resources.Pages.all);
        ...
        {
            var objlist = objRepository.GetList(txtFilterSerial.Text, NullDateifEmpty(txtTransDate.Text), NullDateifEmpty(txtTransactionDateTo.Text), ZeroIntergerIFNull(lstFilterOutType.SelectedValue), ZeroIntergerIFNull(lstFilterRefEmployee.SelectedValue), 0, 0, txtRefNo.Text);
