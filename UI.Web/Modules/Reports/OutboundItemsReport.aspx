<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Masters/Admin.Master" AutoEventWireup="true" CodeBehind="OutboundItemsReport.aspx.cs" Inherits="UI.Web.Modules.WHM.Forms.OutboundItemsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title"><%= GetGlobalResourceObject("pages","DeliverItemsListReport") %> </div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active"><%= GetGlobalResourceObject("pages","DeliverItemsListReport") %></li>
        </ol>
