...
{
    public partial class InboundItemsReport : BaseFormAdmin
    {
        #region "Page Members"
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            var InboundItemList = objRepository.FillInboundItemReport(NullDateifEmpty(txtTransDate.Text), NullDateifEmpty(txtTransactionDateTo.Text));

            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("/Modules/WHM/Reports/RDLC/ar/inboundItemsReport.rdlc");
