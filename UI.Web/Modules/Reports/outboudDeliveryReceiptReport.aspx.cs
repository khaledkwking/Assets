...
{
    public partial class outboudDeliveryReceiptReport : BaseFormAdmin
    {
        #region "Page Members"
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("/Modules/WHM/Reports/RDLC/ar/OutboundDeliverReceipt.rdlc");

                    var objList = objRepository.FillOutboundMaster(ZeroIntergerIFNull(Request.QueryString["id"].ToString()));
