...
{
    public partial class assetsListPopup : BaseFormAdmin
    {
        #region "Page Members"
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lstfilterEmployee.SelectedValue = Request.QueryString["empid"].ToString();

                }
                if (Request.QueryString["locid"] != null)
                {
                    lstFilterLocation.SelectedValue = Request.QueryString["locid"].ToString();
        ...
        private void FillGrid()
        {
            ...
            if (objList != null && objList.Count > 0)
            {
                ...
                lblError.Text = FormatErrorMSG(Resources.Alerts.nodatafound, "2");
            ...
            try
            {
                ...
                for (int i = 0; i <= grdItems.Items.Count - 1; i++)
                {
                    ...
                    if ((grdItems.Items[i].FindControl("chkItem") != null))
                    {
                        ...
                        if (check.Checked)
                        {
                            objList.Add((view_AssetsList)objRepository.getItemDetails(ZeroIntergerIFNull(grdItems.Items[i].Cells[0].Text)));
                        }
                    }
                }
                ...
                //Close popup
                ClientScript.RegisterStartupScript(GetType(), "hwa", "closeMe()", true);
