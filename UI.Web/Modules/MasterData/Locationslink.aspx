<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/_shared/MainEmpty.Master" AutoEventWireup="true" CodeBehind="Locationslink.aspx.cs" Inherits="UI.Web.Modules.MasterData.Locationslink" %>
                        ...
                        <div class="portlet box">
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <div class="pull-left" style="direction:ltr;right:66%;position:relative">
                                        <ul class="link-list-opt no-bdr">
                                            <li>
                                                <asp:LinkButton CssClass="btn btn-primary text-white lnkselected" runat="server"  ID="btnLink" OnClick="btnLink_Click"><i class="icon ni ni-link"></i>&nbsp;<%=GetGlobalResourceObject("pages","linkLocation") %></asp:LinkButton></li>
                                        </ul>
                                    </div>
