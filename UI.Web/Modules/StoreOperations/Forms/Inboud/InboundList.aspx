<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/_shared/Main.Master" AutoEventWireup="true" CodeBehind="InboundList.aspx.cs" Inherits="UI.Web.Modules.StoreOperations.Forms.Inboud.InboundList" %>
                    ...
                    <div class="card-title-group" data-select2-id="21">
                        ...
                        <div class="card-search search-wrap" data-search="search">
                            <div class="search-content">
                                ...
                                <asp:TextBox ID="txtFilterSerial" runat="server" CssClass="form-control border-transparent form-focus-none" placeholder="IN/Serial/CMGSYY "></asp:TextBox>
                            ...
                            <asp:TemplateColumn HeaderText="">
                                ...
                                <ItemTemplate>
                                    ...
                                    <div style="direction: rtl; text-align: right">
                                        ...
                                        <asp:DataGrid runat="server" ID="grdInboundItems" AutoGenerateColumns="False"
                                            AllowPaging="false" class="table table-hover table-striped table-bordered table-advanced tablesorter">
...
<%--                                                <asp:TemplateColumn HeaderText="<%$ Resources:pages,image %>">
                            ...
                            <asp:BoundColumn DataField="TransDate" HeaderText=" <%$ Resources:pages,TransDate %>  " DataFormatString="{0:dd/MM/yyyy}"></asp:BoundColumn>
                                ...
                                <asp:TemplateColumn HeaderText="<%$ Resources:pages,InboundType %>">
                                <ItemTemplate>

                                    <%# showRequestType(ZeroIntergerIFNull(gets(Eval("InboundTypeCode"))), gets( Eval("TypeTitlear"))) %>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:BoundColumn DataField="DeliveryOrderNo" HeaderText="<%$ Resources:pages,DeliveryOrder %> "></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="<%$ Resources:pages, LastStatus %>">
                                <ItemStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                     <%# showRequestStatus(ZeroIntergerIFNull(gets(Eval("InboundLastStatusCode"))), gets( Eval("InboundLastStatus"))) %>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn>
                                <HeaderStyle HorizontalAlign="Center" />
                                    ...
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="link-list-opt no-bdr">
                                                <li>
                                                    <a href="InboundOperrations.aspx?id=<%#Eval("code") %>" class="btn btn-default btn-xs"><i class="icon ni ni-edit"></i>&nbsp; <%=GetGlobalResourceObject("pages","Details") %> </a>
                                                </li>
