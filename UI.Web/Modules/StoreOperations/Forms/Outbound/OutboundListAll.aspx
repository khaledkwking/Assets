<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/_shared/Main.Master" AutoEventWireup="true" CodeBehind="OutboundListAll.aspx.cs" Inherits="UI.Web.Modules.StoreOperations.Forms.Outbound.OutboundListAll" %>
                                        ...
                                        <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-right" style="" data-select2-id="16">
                                            ...
                                            <div class="dropdown-body dropdown-body-rg" data-select2-id="15">
                                                <div class="row gx-6 gy-4" data-select2-id="14">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label class="overline-title overline-title-alt"><%=GetGlobalResourceObject("pages","outboundType") %></label>

                                                            <asp:DropDownList ID="lstFilterOutType" runat="server" class="form-control form-select" data-search="on" ClientIDMode="Static"></asp:DropDownList>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="<%$ Resources:pages,CustodyType %>">
                                <ItemTemplate>
                                    ...
                                    <%# showRequestType(ZeroIntergerIFNull(gets(Eval("TypeCode"))), gets( Eval("TypeTitlear"))) %>
                                </ItemTemplate>
                            </asp:TemplateColumn>
