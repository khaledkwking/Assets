...
{
    public partial class OutboundListReport : BaseFormAdmin
    {
        #region "Page Members"
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("/Modules/WHM/Reports/RDLC/Outboundlist.rdlc");
                if (Session["OutboundListResult"] != null)
                {
                    ReportDataSource datasource = new ReportDataSource("ds_outbound", (List<View_OutboundList>)Session["OutboundListResult"]);
