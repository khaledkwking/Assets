namespace Infrastructure.EnterpriseLibrary
{
    using System;
    ...
    public class UnityPerWebRequestLifetimeModule : DispoInfrastructurebleResource, IHttpModule
    {
        ...
        internal void RemoveAllInstances()
        {
            ...
            if (!instances.IsNullOrEmpty())
            {
                ...
                {
                    IDisposable dispoInfrastructureble = entry.Value as IDisposable;

                    if (dispoInfrastructureble != null)
                    {
                        dispoInfrastructureble.Dispose();
                    }
                }
