<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/_shared/Main.Master" AutoEventWireup="true" CodeBehind="AssetRegister.aspx.cs" Inherits="UI.Web.Modules.Assets.AssetRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        $(document).ready(function () {
         ...
         $("#lstRefEmployee").change(function() {
    var selectedValue = $(this).val();
    if (selectedValue) {
        // Make an AJAX call to the server-side function
        $.ajax({
            type: "GET",
            url: "/api/hepler/HandleEmployeeSelection", // Update with your page's name
            ...
            success: function(response) {
                ...
                if (Array.isArray(response) && response.length > 0) {
                    var employee = response[0]; // Get the first employee from the list
                   // alert(employee.EMP_NAME + " - " + employee.JOB_NAME + " - " + employee.EMP_ID + " - " + employee.LOCATION_NAME + " - ");
                    //$('.divSelectedEmployeeInfo').show();

                    //$("#lblSelectedEmpName").text(employee.EMP_NAME);
                    //
                    $('#<%=lblSelectedEmpName.ClientID %>').text(employee.EMP_NAME);
                    $('#<%=lblSelectedjobTitle.ClientID %>').text(employee.JOB_NAME);
                    $('#<%=lblSelectedEmpCode.ClientID %>').text(employee.EMP_ID);
                    $('#<%=lblSelectedEmpLocationName.ClientID %>').text(employee.LOCATION_NAME);
                    $('#<%=divSelectedEmployeeInfo.ClientID %>').show();

                } else {
                    console.log("No employee data found.");
                    // Optionally, you can clear the fields if no employee is found
                    $("#lblSelectedEmpName").text("");
                    $("#lblSelectedjobTitle").text("");
                    $("#lblSelectedEmpCode").text("");
                    $("#lblSelectedEmpLocationName").text("");
                }
            },
        ...
        $("#result").text(""); // Clear the result if no option is selected
    }
});
    ...
    <input id="hdnGridData" runat="server" type="hidden" />
                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group divEmployee" id="divEmployee" runat="server">
                                                                    ...
                                                                    <asp:DropDownList ID="lstRefEmployee" runat="server" class="form-control form-select lstRefEmployee" 
                                                                        data-search="on" ClientIDMode="Static"  OnSelectedIndexChanged="lstRefEmployee_SelectedIndexChanged" 
                                                                        AutoPostBack="true">
                                                                    </asp:DropDownList>
                                                            ...
                                                            <div class="col-md-4 divSelectedEmployeeInfo" id="divSelectedEmployeeInfo" runat="server" style="display:none">
                                            ...
                                            <div class="card-inner">
                                                <%--<asp:UpdatePanel runat="server" ID="upGridView" ChildrenAsTriggers="true" UpdateMode="conditional">--%>
                                                <asp:UpdatePanel runat="server" ID="upGridViewss">
