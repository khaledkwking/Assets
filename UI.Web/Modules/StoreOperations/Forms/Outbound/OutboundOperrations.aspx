<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/_shared/Main.Master" AutoEventWireup="true" CodeBehind="OutboundOperrations.aspx.cs" Inherits="UI.Web.Modules.StoreOperations.Forms.Outbound.OutboundOperrations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        function chkImage() {
            ...
            var hdnRequestType = document.getElementById("<%=hdnRequestType.ClientID %>")
            if (hdnRequestType.value == "1" || hdnRequestType.value == "2") {
            ...
            var txt = document.getElementById("<%=hdnRequestType.ClientID %>")
            if (txt.value == "1") {
                var txt = document.getElementById("<%=lstRefEmployee.ClientID %>")
                if (txt.value == "" || txt.value == "0") {
                    ...
                    <div class="card-inner p-0">
                        <div class="portlet box">
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-md-3" style="background: #f2f2f2; padding: 10px; border-radius: 5px;" id="divLocation" runat="server">
                                        ...
                                        <div class="panel panel-yellow" style="min-height: 70vh">
                                            ...
                                            <div class="panel-body" style="padding: 0px; padding-top: 25px;">
                                                <div class="spinner-grow" role="status" id="progressbar">
                                    ...
                                    <div class='<%=hdnRequestType.Value=="3"?"col-md-12":"col-md-9" %>'>
                                        <asp:UpdatePanel runat="server" ID="Updatepanel2" ChildrenAsTriggers="true" UpdateMode="conditional">
                                            <ContentTemplate>
                                                ...
                                                <div id="tblShow" class="bg-roundedgray">
                                                        ...
                                                        <div class="tab-pane <%=getActiveTab("1") %>" id="BasicInfo">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="form-group" id="divToStore" runat="server">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        ...
                                                                                                        <asp:DropDownList ID="lstStatusCode" Enabled="false" runat="server" class="form-control"></asp:DropDownList>
                                                                                                    </div>
                                                                        ...
                                                                        <div class="portlet-body">
                                                                            <asp:DataGrid runat="server" ID="grdOutboundItems" AutoGenerateColumns="False" OnEditCommand="grdOutboundItems_EditCommand" OnDeleteCommand="grdOutboundItems_DeleteCommand"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundColumn DataField="DeliveredQry" HeaderText="<%$ Resources:pages,DeliveredQry %>"></asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="TitleAr" HeaderText="<%$ Resources:pages,QUnit %>"></asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="StatusTitleAr" HeaderText="<%$ Resources:pages,StatusCode %>"></asp:BoundColumn>
    ...
    <script src="/Layout/Assets/businessScripts/Custody.js"></script>
</asp:Content>
